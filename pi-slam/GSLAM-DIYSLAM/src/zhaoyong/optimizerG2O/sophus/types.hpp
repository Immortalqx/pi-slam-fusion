...
public:
    ...
    virtual void oplusImpl(const double* update_)  {
//        GSLAM::ScopedTimer tm("VertexSE3::oplusImpl");
...
public:
    ...
    void computeError()  {
//        GSLAM::ScopedTimer tm("EdgeSE3PinHoleXYZ::computeError");
...
//        GSLAM::ScopedTimer tm("EdgeSE3PinHoleXYZ::linearizeOplus");
...
public:
    ...
    void computeError()
    {
        ...
        Sophus::SE3d error_= _from->estimate()*_to->estimate().inverse()* _inverseMeasurement;
        //_from->estimate().inverse() * _to->estimate() * _inverseMeasurement;
        _error = error_.log();
