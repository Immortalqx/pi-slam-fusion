...
{
public:
    SLAMVisualizerImpl() : _slam(NULL), _firstFrame(true){}
    ~SLAMVisualizerImpl(){
    }
...
SLAMVisualizer::SLAMVisualizer(QWidget* parent)
    :QGLViewer(parent), impl(new SLAMVisualizerImpl())
{
}


void SLAMVisualizer::setSLAM(GSLAM::SLAM* s)
{
    impl->_slam = s;
    impl->_firstFrame = true;
...
GSLAM::SLAM* SLAMVisualizer::slam()
{
    return impl->_slam;
}
