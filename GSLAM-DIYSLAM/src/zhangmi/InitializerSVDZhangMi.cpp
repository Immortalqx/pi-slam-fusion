...
public:
    InitializerSVD(float sigma = 1.0, int iterations = 200);
                                  ...
                                  float minParallax, int minTriangulated)
{
    ...
    int nGood1 = CheckRT(R1,t1,mvPn1,mvPn2,vbMatchesInliers,K, vP3D1, 4.0*mSigma2, vbTriangulated1, parallax1);
    int nGood2 = CheckRT(R2,t1,mvPn1,mvPn2,vbMatchesInliers,K, vP3D2, 4.0*mSigma2, vbTriangulated2, parallax2);
    int nGood3 = CheckRT(R1,t2,mvPn1,mvPn2,vbMatchesInliers,K, vP3D3, 4.0*mSigma2, vbTriangulated3, parallax3);
    int nGood4 = CheckRT(R2,t2,mvPn1,mvPn2,vbMatchesInliers,K, vP3D4, 4.0*mSigma2, vbTriangulated4, parallax4);
...
typedef zhangmi::InitializerSVD InitializerSVD;
REGISTER_INITIALIZER(InitializerSVD,svdzm);
